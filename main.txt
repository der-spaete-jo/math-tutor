...
class ResponseTimer(Label):
    ...
    def checkpoint(self):
        ...
        """
        if self._checkpoint:
            return self._cur_time - self._checkpoint
        else:
...
class ResultScreen(Screen):
    ...
    def set_results(self, operation, difficulty, num_questions, questions, answer_times, tot_resp_time, avg_resp_time, min_resp_time, max_resp_time):
        ...
        """
        self.total_response_time.text = str(tot_resp_time)[self._slicer]
        self.average_response_time.text = str(avg_resp_time)[self._slicer]
        ...
        self.minimum_response_time.text = str(min_resp_time)[self._slicer] + '\n( ' + str(q_min[0]) + ' ' + MathBackEnd.operator_strings[q_min[2]] + ' ' + str(q_min[1]) + ' )'
        self.maximum_response_time.text = str(max_resp_time)[self._slicer] + '\n( ' + str(q_max[0]) + ' ' + MathBackEnd.operator_strings[q_max[2]] + ' ' + str(q_max[1]) + ' )'
